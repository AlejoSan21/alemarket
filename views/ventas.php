...
<div class="main-panel">
    ...
    <div class="content-grid terminal-grid">
        
        <div class="sidebar-panel">
            <section class="panel-block terminal-side-card">
            ...
            <section class="panel-block terminal-side-card">
                ...
                <form method="POST" class="sidebar-panel">
                    ...
                    <div class="input-row">
                        <input type="number" name="cantidad" value="1" min="1" class="input-pro">
                        <button type="submit" name="agregar_prod" class="btn-panel primary">Agregar</button>
                    </div>
                </form>
            </section>

            <?php if(!empty($_SESSION['carrito'])): ?>
            <section class="panel-block terminal-side-card" style="border-top: 4px solid var(--success-color);">
            ...
            <table class="compact-table">
                ...
                <tbody>
                    <?php $total = 0; if(empty($_SESSION['carrito'])): ?>
                        <tr><td colspan="4" class="terminal-table-placeholder">No hay productos en la venta</td></tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="ventas.php?borrar_item=<?php echo $index; ?>" class="btn-panel danger">Cancelar</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
